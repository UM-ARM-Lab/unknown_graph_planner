...
bool checkEdge(GraphD &g, arc_dijkstras::GraphEdge &e, const Obstacles2D::Obstacles &obs) {
...
inline arc_helpers::AstarResult AstarPlan(RDiscGraph &g, const Obstacles2D::Obstacles &obs,
  ...
  const auto heuristic_function = [&g](const std::vector<double> &q1, const std::vector<double> &q2) {
